...
public class Solution {
  public int largest(int[][] matrix) {
    ...
    // leftup records the longest possible length for left and up arms
    // ending at each cells in the matrix
  ...
  // in the two matrix, also it returns the max value among
  // all the cells in the merged matrix
