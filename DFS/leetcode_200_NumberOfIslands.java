...
// similar explanation is added in Union Find folder,
// for BFS, DFS, we need to traverse in 4 directions to make sure everything is covered
...
// explanation graph: https://imgur.com/gallery/M58OKvB
class Solution {
  public int numIslands(char[][] grid) {
    if (grid == null || grid.length == 0) {
      return 0;
